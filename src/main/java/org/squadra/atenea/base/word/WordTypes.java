...
public class WordTypes {
	...
	public static final String VOID = ""; // VACIO (cuando el campo DEBE estar
											// vacio)
	public static final String UNKNOWN = "?"; // DESCONOCIDO (cuando esta vacio
												// porque no sabemos que poner)
	...
	public static class Type {
		...
		public static final String PERSONAL_PRONOUN = "PERS"; // PRONOMBRE
																// PERSONAL

		// Los siguientes tipos abarcan pronombres, adjetivos y algunos
		// adverbios
		public static final String DEMONSTRATIVE = "DEM"; // PRONOMBRE
															// DESMOSTRATIVO
		...
		public static final String INTERROGATIVE = "INTERR"; // PRONOMBRE
																// INTERROG/EXCLAMATIVO
		...
		public static class AdverbSubtype {
			...
			public static final String NEGATION = "aneg"; // ADVERBIO DE
															// NEGACION
			public static final String AFFIRMATION = "aaff"; // ADVERBIO DE
																// AFIRMACION
			public static final String DOUBT = "adou"; // ADVERBIO DE DUDA
			public static final String QUANTIFIER = "aquant"; // ADVERBIO
																// CUANTIFICADOR
		}
	...
	public static class Number {
		...
		public static final String INDEFINITE = "SP"; // INDEFINIDO (para
														// nombres propios)
	}
	...
	public static class Tense {
		...
		public static final String PAST_IMPERFECT = "IMPF"; // PRET. IMPERFECTO
															// jugaba
		public static final String PAST_SIMPLE = "PS"; // PRET. PERFECTO SIMPLE
														// jugue
		public static final String FUTURE = "FUT"; // FUTURO SIMPLE jugare
		public static final String CONDITIONAL = "COND"; // CONDICIONAL SIMPLE
															// jugaria
	...
	public static class Person {
		...
		public static final String _1y3S = "1/3S"; // 1ra y 3ra PERSONA DEL
													// SINGULAR
		public static final String _3SyP = "3S/P"; // 3ra PERSONA DEL SINGULAR O
													// PLURAL
